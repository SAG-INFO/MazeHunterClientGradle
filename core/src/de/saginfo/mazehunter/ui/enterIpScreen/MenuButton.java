...
public class MenuButton extends TextButton{
    ...
    private static class MenuButtonStyle extends TextButtonStyle{
        public MenuButtonStyle() {
            ...
            Sprite upSprite = new Sprite(new Texture("ui\\menuButtonUp.png"));
            Sprite downSprite = new Sprite(new Texture("ui\\menuButtonDown.png"));
            Sprite overSprite = new Sprite(new Texture("ui\\menuButtonOver.png"));
